...
Se aparecer erro `403` com `invalid_workspace_selected`, consulte `docs/CODEX_TROUBLESHOOTING.md`. Também existe o utilitário `tools/extract_codex_403_info.py` para automatizar a triagem do erro.
